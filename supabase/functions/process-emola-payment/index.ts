...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const emolaPayload = { merchant_id: EMOLA_MERCHANT_ID, customer_msisdn: formattedPhone, amount: paymentAmount, reference: transactionRef, description: "NAVANHULA CLOUD - Assinatura mensal" };
