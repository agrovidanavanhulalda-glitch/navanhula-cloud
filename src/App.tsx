...
const FounderFiscalDashboardPage = React.lazy(() => import("./pages/founder/FounderFiscalDashboardPage"));
...
const FounderExecutiveAnalyticsPage = React.lazy(() => import("./pages/founder/FounderExecutiveAnalyticsPage"));
const FounderOperationsIntelligencePage = React.lazy(() => import("./pages/founder/FounderOperationsIntelligencePage"));
...
const FounderPolicyCenterPage = React.lazy(() => import("./pages/founder/FounderPolicyCenterPage"));
const FounderStrategyCenterPage = React.lazy(() => import("./pages/founder/FounderStrategyCenterPage"));
const FounderGovernanceCenterPage = React.lazy(() => import("./pages/founder/FounderGovernanceCenterPage"));
const FounderDecisionCenterPage = React.lazy(() => import("./pages/founder/FounderDecisionCenterPage"));
const FounderArchitectureCenterPage = React.lazy(() => import("./pages/founder/FounderArchitectureCenterPage"));
const FounderTransformationCenterPage = React.lazy(() => import("./pages/founder/FounderTransformationCenterPage"));
const FounderRiskCenterPage = React.lazy(() => import("./pages/founder/FounderRiskCenterPage"));
...
const FounderCustomer360Page = React.lazy(() => import("./pages/founder/FounderCustomer360Page"));
const FounderCustomerReleaseCenterPage = React.lazy(() => import("./pages/founder/FounderCustomerReleaseCenterPage"));
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <Route path="founder" element={<FounderGate><FounderLayout /></FounderGate>}>
            ...
            <Route path="approval-center" element={<FounderApprovalCenterPage />} />
            <Route path="knowledge-center" element={<FounderKnowledgeCenterPage />} />
            <Route path="simulation-lab" element={<FounderSimulationLabPage />} />
            <Route path="policy-center" element={<FounderPolicyCenterPage />} />
            <Route path="strategy-center" element={<FounderStrategyCenterPage />} />
            <Route path="governance-center" element={<FounderGovernanceCenterPage />} />
            <Route path="decision-center" element={<FounderDecisionCenterPage />} />
            <Route path="architecture-center" element={<FounderArchitectureCenterPage />} />
            <Route path="transformation-center" element={<FounderTransformationCenterPage />} />
            <Route path="risk-center" element={<FounderRiskCenterPage />} />
            ...
            <Route path="customer-360" element={<FounderCustomer360Page />} />
            <Route path="customer-release" element={<FounderCustomerReleaseCenterPage />} />
          </Route>
