        ...
        {navItems.map((item) => {
            ...
            return (
              <Sheet key={item.label} open={menuOpen} onOpenChange={setMenuOpen}>
                <SheetTrigger asChild>
                  <button className="flex flex-col items-center justify-center gap-0.5 flex-1 py-1 transition-colors text-muted-foreground">
          ...
          return (
            <button
              ...
              className={cn(
                "flex flex-col items-center justify-center gap-0.5 flex-1 py-1 transition-all duration-200 relative",
